...
func (f *FakeRuntime) SyncPod(_ context.Context, pod *v1.Pod, _ *kubecontainer.PodStatus, _ []v1.Secret, backOff *flowcontrol.Backoff, _ kubecontainer.ResizeInProgressUpdater) (result kubecontainer.PodSyncResult) {
	f.Lock()
	defer f.Unlock()
