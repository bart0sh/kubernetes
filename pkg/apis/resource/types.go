...
type CELSelector struct {
	...
	// `device.capacities` map.
	//
	// In both maps unknown keys trigger a runtime error.
	//
	...
	//
	// Some examples:
	//    "dra.example.com/memory" in device.capacities && # Is the quantity available?
